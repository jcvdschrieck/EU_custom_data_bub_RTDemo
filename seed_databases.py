...
def main():
    ...
    from lib.seeder import seed_european_custom_db, seed_simulation_db
    ...
    # ── Simulation DB (March 2026) ────────────────────────────────────────────
    print(f"\n[2/2] Seeding Simulation Database ({SIMULATION_DB.name})…")
    t0 = time.perf_counter()
    n2 = seed_simulation_db()
